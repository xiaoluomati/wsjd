 ...
 *
 */
public class XzzsCpfxgcParseRule extends GeneralCpfxgcCommonRule implements CpfxgcParseRule{
	...
	public WscpfxgcModel jxWscpfxgcModel(WsAnalyse wsAnalyse) {
		...
		ArrayList<String> contentlist = WsAnalyse.getWholeContent(wscpfxgc.get(wscpfxgc.size() - 1));
		int index = 0;
